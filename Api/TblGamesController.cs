...
namespace tttServer.Api
{
    ...
    {
        private readonly tttGamesContext _context;

        public TblGamesController(tttGamesContext context)
        {
            _context = context;
        }
        ...
        // GET: api/TblGames/player/id
        [HttpGet("player/{id}")]
        public async Task<List<TblGames>> GetTblGamesByPlayer(int id)
        {
